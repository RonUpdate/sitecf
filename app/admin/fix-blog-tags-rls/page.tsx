...
export default async function FixBlogTagsRlsPage() {
  ...
  return (
    <div className="container mx-auto py-6">
      <h1 className="text-3xl font-bold mb-6">Исправление настроек RLS для таблицы blog_tags</h1>

      <div className="grid gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Таблица blog_tags</CardTitle>
            <CardDescription>Управление настройками Row Level Security (RLS) для таблицы blog_tags</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="mb-4">
              ...
              {rlsError ? (
                ...
                <p>
                  RLS для таблицы blog_tags:
                  <span className={rlsStatus?.rowsecurity ? "text-green-500 font-bold ml-2" : "text-gray-500 ml-2"}>
            ...
            <div className="mb-4">
              ...
              {policiesError ? (
                ...
                <p className="text-yellow-500">Для таблицы blog_tags не определены политики RLS.</p>
              )}
            </div>

            <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-md">
              <p className="text-yellow-600 dark:text-yellow-400">
                <strong>Проблема:</strong> Для таблицы blog_tags включена защита на уровне строк (RLS), но не определены
                политики доступа. Это означает, что таблица фактически недоступна для всех пользователей, кроме
                владельца таблицы.
              </p>
            </div>
          </CardContent>
